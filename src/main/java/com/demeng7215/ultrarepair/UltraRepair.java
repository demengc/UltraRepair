...
public class UltraRepair extends JavaPlugin {
	...
	@Getter
	private CustomConfig settingsFile, messagesFile;
	...
	public void onEnable() {
		...
		MessageUtils.console("&aUltraRepair v" + Common.getVersion() + " by Demeng7215 " +
				"has been successfully enabled!");
	}

	@Override
	public void onDisable() {
		MessageUtils.console("&cUltraRepair v" + Common.getVersion() + " by Demeng7215 " +
